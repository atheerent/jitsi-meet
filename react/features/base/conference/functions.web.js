...
import { iframeMessages, sendMessage, getUserHash, getDeviceType, removeUser } from '../../../../atheer';
...
export function commonUserJoinedHandling(
        ...
        conference: Object,
        user: Object) {
    sendMessage(iframeMessages.userJoined, {userHash: getUserHash(user), deviceType: getDeviceType(user)});
    const id = user.getId();
...
export function commonUserLeftHandling(
        ...
        conference: Object,
        user: Object) {
    sendMessage(iframeMessages.userLeft, {userHash: getUserHash(user)});
    const id = user.getId();
    removeUser(id);
