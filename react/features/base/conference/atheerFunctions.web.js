...
import { ATHEER_MESSAGE, sendMessage, getUserHash } from '../../../../atheer';
...
export function commonUserJoinedHandling(
    ...
    sendMessage(ATHEER_MESSAGE.PARTICIPANT_JOINED, {userHash: getUserHash(user), participantId: id});
    if (user.isHidden()) {
...
export function commonUserLeftHandling(
    ...
    sendMessage(ATHEER_MESSAGE.PARTICIPANT_LEFT, {userHash: getUserHash(user), participantId: id});
    if (user.isHidden()) {
