...
import { iframeMessages, sendMessage } from '../../../../atheer';
        ...
        if (state.jitsiTrack === t.jitsiTrack) {
            ...
            for (const p in t) {
                if (state[p] !== t[p]) {
                    ...
                    if (t.jitsiTrack.type === 'audio' && !t.jitsiTrack.ownerEndpointId) {
                        sendMessage(iframeMessages.userMuteChanged, {
                            status: t.jitsiTrack.isMuted()
                        });
                    }
                    return {
                        ...state,
