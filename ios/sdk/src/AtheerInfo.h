 ...
 * User display name.
 */
@property (nonatomic, nullable) CameraResolutionInfo *cameraResolutionInfo;
...
- (instancetype _Nullable)initWithProxyServerInfo:(ProxyServerInfo *_Nullable)proxyServerInfo
                               ...
                               andCameraResolutionInfo:(CameraResolutionInfo *_Nullable)cameraResolutionInfo;
